...
export default function Register(){
  ...
  async function submit(e){
    ...
    try{
      ...
      // Normal registration gives user access (not admin)
      ...
      if (redirectUrl) {
        ...
        // Always redirect to user dashboard from normal registration
        nav('/user-dashboard')
      }
    }catch(e){
      ...
      <div className='max-w-md mx-auto px-4'>
        ...
        >
          <div className='text-center mb-8'>
            ...
            <p className='text-slate-600 mt-2'>Join CityCare Hospital</p>
          </div>
            ...
            <div>
              ...
              <div className='relative'>
                ...
                <select
                  ...
                  className='w-full pl-10 pr-4 py-3 border border-slate-300 rounded-lg focus:ring-2 focus:ring-sky-600 focus:border-transparent appearance-none bg-white'
                >
