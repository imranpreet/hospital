  ...
  return (
    <div>
      ...
      <section className='py-16 bg-gradient-to-br from-slate-50 to-blue-50'>
        <div className='max-w-6xl mx-auto px-4'>
          <div className='text-center mb-12'>
            ...
            <p className='text-lg text-slate-600'>Choose your role to continue</p>
          </div>
      ...
      <section className='py-16 bg-slate-50'>
        <div className='max-w-6xl mx-auto px-4'>
          <div className='text-center mb-12'>
            <h2 className='text-4xl font-bold text-slate-900 mb-4'>Simple Steps to Get Started</h2>
            <p className='text-lg text-slate-600'>Book your appointment in 3 easy steps</p>
          </div>
          ...
          <div className='grid grid-cols-1 md:grid-cols-3 gap-8'>
            <motion.div
              ...
              className='text-center'
            >
              <div className='w-16 h-16 bg-sky-600 text-white rounded-full flex items-center justify-center text-2xl font-bold mx-auto mb-4'>1</div>
              <h3 className='text-xl font-semibold mb-2'>Register Account</h3>
              <p className='text-slate-600'>Create your account with basic details in under 2 minutes</p>
            </motion.div>
            ...
            <motion.div
              ...
              className='text-center'
            >
              <div className='w-16 h-16 bg-sky-600 text-white rounded-full flex items-center justify-center text-2xl font-bold mx-auto mb-4'>2</div>
              <h3 className='text-xl font-semibold mb-2'>Choose Doctor</h3>
              <p className='text-slate-600'>Browse specialists and select your preferred doctor</p>
            </motion.div>
            ...
            <motion.div
              ...
              className='text-center'
            >
              <div className='w-16 h-16 bg-sky-600 text-white rounded-full flex items-center justify-center text-2xl font-bold mx-auto mb-4'>3</div>
              <h3 className='text-xl font-semibold mb-2'>Book Appointment</h3>
              <p className='text-slate-600'>Select date & time, confirm booking and get instant confirmation</p>
            </motion.div>
          </div>
